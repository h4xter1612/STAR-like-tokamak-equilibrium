...
# CS_MID_current  = -3729649.665502105
# CS_END_current  = -2136117.664484214
# CS_current  =  -5500000.0*(0.0)
# PF1_current = -1848443.9026171772
# PF2_current =  -2821918.8734831177*(1.0)
# PF3_current =  1688015.6292537155
# PF4_current = 5239815.487861866
# PF5_current =  5004189.204634282
# PF6_current =  10973208.70827962

# CS_MID_current  = -3729649.665502105*(8.0)
# CS_END_current  = 2136117.664484214*(10.0)
# CS_current  =  -5500000.0*(0.0)
# PF1_current = -1848443.9026171772
# PF2_current =  -2821918.8734831177*(1.1)
# PF3_current =  1688015.6292537155
# PF4_current = 5239815.487861866*(1)
# PF5_current =  5004189.204634282*(1)
# PF6_current =  10973208.70827962*(1)

# CS_MID_current  = -3729649.665502105*(1.0)
# CS_END_current  = -2136117.664484214*(1.0)
# CS_current  =  -5500000.0*(0.0)
# PF1_current = -1848443.9026171772*(0.8)
# PF2_current =  -2821918.8734831177*(1.0)
# PF3_current =  1688015.6292537155*(0.9)
# PF4_current = 5239815.487861866
# PF5_current =  5004189.204634282
# PF6_current =  10973208.70827962
...
# CS_END_current  = -2136117.664484214*(-1.0)
# CS_current  =  -5500000.0*(0.0)
# PF1_current = -1848443.9026171772*(0.73)
# PF2_current =  -2821918.8734831177*(1.1)
# PF3_current =  1688015.6292537155*(0.76) #0.8
# PF4_current = 5239815.487861866*(1.0)
# PF5_current =  5004189.204634282*(0.8)
# PF6_current =  10973208.70827962*(0.8)

# CS_MID_current  = -3729649.665502105*(7.0)
# CS_END_current  = -2136117.664484214*(-7.0) # -1
# CS_current  =  -5500000.0*(0.0)
# PF1_current = -1848443.9026171772*(0.61)
# PF2_current =  -2821918.8734831177*(1.18)
# PF3_current =  1688015.6292537155*(0.76) #0.8
# PF4_current = 5239815.487861866*(1.0)
# PF5_current =  5004189.204634282*(0.8)
# PF6_current =  10973208.70827962*(0.8)
...
# CS_END_current  = -2136117.664484214*(-10.0)
# CS_current  =  -5500000.0*(0.0)
# PF1_current = -1848443.9026171772*(0.51)
# PF2_current =  -2821918.8734831177*(1.25) # 1.18
# PF3_current =  1688015.6292537155*(0.76) #0.8
# PF4_current = 5239815.487861866*(1.0)
# PF5_current =  5004189.204634282*(0.8)
# PF6_current =  10973208.70827962*(0.8)

# CS_MID_current  = -3729649.665502105*(7.0)*0
# CS_END_current  = -2136117.664484214*(-10.0)*0
# CS_current  =  -5500000.0*(0.0)
# PF1_current = -1848443.9026171772*(0.27)
# PF2_current =  -2821918.8734831177*(1.44)
...
# CS_MID_current  = -3729649.665502105*(7.3)
# CS_END_current  = -2136117.664484214*(7.0)
# CS_current  =  -5500000.0*(0.0)
# PF1_current = -1848443.9026171772*(0.27)
# PF2_current =  -2821918.8734831177*(1.52)
# PF3_current =  1688015.6292537155*(0.76)
# PF4_current = 5239815.487861866*(1.0)
# PF5_current =  5004189.204634282*(0.8)
# PF6_current =  10973208.70827962*(0.6)


# CS_MID_current  = -3729649.665502105*(7.6)
# CS_END_current  = -2136117.664484214*(7.0)
# CS_current  =  -5500000.0*(0.0)
# PF1_current = -1848443.9026171772*(0.23)
# PF2_current =  -2821918.8734831177*(1.52)
# PF3_current =  1688015.6292537155*(0.76)
# PF4_current = 5239815.487861866*(0.3)
# PF5_current =  5004189.204634282*(1.0)
# PF6_current =  10973208.70827962*(0.6)
...
# PF2_current =  -2821918.8734831177*(1.54)
# PF3_current =  1688015.6292537155*(0.76)
# PF4_current = 5239815.487861866*(0.3)
# PF5_current =  5004189.204634282*(1.0)
# PF6_current =  10973208.70827962*(0.59)

CS_MID_current  = -3729649.665502105*(8.5) #7.7
CS_END_current  = -2136117.664484214*(7.0)
CS_current  =  -5500000.0*(0.0)
PF1_current = -1848443.9026171772*(0.21)
...
# ----------------------------
Ip      = 4.0e6 # 1.72e6 4.0e6 13.2e6
paxis   = 2.0e3 # Pa 1e5 2.0e3
scan = 0
if scan == 0:
    import os
    Ip = float(os.environ.get("STAR_IP_A", Ip))
...
# ----------------------------
target_rel_tol = 5e-5 # 5e-5 1e-9
target_rel_tol_ramp = 2e-5 # 2e-5 1e-8
